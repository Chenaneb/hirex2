...
<head>
  ...
  <title>Hirex Employee Management system</title>
        ...
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
          <div class="flex items-center flex-1">
            ...
            <div class="hidden space-x-8 md:flex md:ml-10">
              ...
              <a href="#" class="text-base font-medium text-white hover:text-gray-300">FAQ</a>
...
<div class="hidden space-x-8 md:flex md:ml-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-blue-300 underline">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-blue-300 underline">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-blue-300 underline">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
        ...
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
          ...
          <div class="pt-5 pb-6">
            <div class="px-2 space-y-1">
              ...
              <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">FAQ</a>
...
<main>
      <div class="pt-10 bg-gray-500 sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
        <div class="mx-auto max-w-7xl lg:px-8">
          <div class="lg:grid lg:grid-cols-2 lg:gap-8">
            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
              <div class="lg:py-24">
                ...
                <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                  <span class="block">Hirex Employee</span>
                  <span class="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">Management System</span>
                </h1>
                <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">Welcome to the Employee management system</p>
            ...
            <a href="{{ route('login') }}" class="block w-full py-3 px-4 rounded-md shadow bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-medium hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 focus:ring-offset-gray-900"> Log in </a>
        <!-- <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700"> Start free trial </a> -->
          </div>
