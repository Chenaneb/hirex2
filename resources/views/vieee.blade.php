    ...
    -->
        ...
        -->
            ...
            Leaving: "transition ease-in-out duration-300 transform"
              ...
              To: "-translate-x-full"
          -->
                    <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-500">
                        <!--
            ...
            -->
                        ...
                        <div class="mt-5 flex-1 h-0 overflow-y-auto">
                            <nav class="px-2 space-y-1">
                                ...
                                <a href="#"
                                    class="bg-gray-500 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                    <!--
                ...
                <div class="flex-1 flex flex-col min-h-0 bg-gray-500">
                    ...
                    <div class="flex-1 flex flex-col overflow-y-auto">
                        <nav class="flex-1 px-2 py-4 space-y-1">
                            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                            <a href="#"
                                class="bg-gray-500 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <!--
                  Heroicon name: outline/home
